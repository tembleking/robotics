...
with description('Geometry', 'unit') as self:
    ...
    with it('calculates the reverse location correctly'):
        ...
        expect(b.inverse()).to(equal(Location.from_angle_degrees(Point(-1, 1), -90)))
